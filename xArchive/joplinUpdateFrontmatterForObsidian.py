...
# ORIGINAL SOURCE: https://github.com/pickerin/joplin-update-frontmatter
# COPIED AND ADDED TO MY GRABBAG REPO ON 2021-10-15
# This was done rather than forking pickerin's repo so my miscellaneous scripts are in one place and I don't need to 
# manage yet another repo.
# Mike's Grabbag repo is at https://gitlab.com/mikeo85/grabbag
...
TOKEN = "a9689a106b102c722227e545270f4d00031208e5c6e688701761fff55226af910d5adc784fab5a5a4c38108aed09988d60eb6b6e471cb128c90663b288dc0c79"
...
def get_note_metadata(noteid):
    ...
    return requests.get('{}/{}/?fields=body,title,user_created_time,user_updated_time,parent_id,source_url&token={}'.format(NOTES_ENDPOINT, noteid, TOKEN))
